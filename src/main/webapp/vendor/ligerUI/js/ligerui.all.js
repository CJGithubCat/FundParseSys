    ...
    $.ligerui.controls.Grid.ligerExtend($.ligerui.core.UIComponent, {
        ...
        */
        ...
        _getCellHtml: function (rowdata, column)
        {
            ...
            //htmlarr.push('<div');
            htmlarr.push(' style = "white-space: pre;width:' + parseInt(column._width - 8) + 'px;');
...
(function ($)
{
    ...
    $.ligerui.controls.Menu.ligerExtend($.ligerui.core.UIComponent, {
        ...
        addItem: function (item, menu)
        {
            ...
            var defaultWidth=40;
        	sreccWidth<=1366?defaultWidth:defaultWidth=0;
            ditem.hover(function ()
            {
                ...
                if (item.children)
                {
                    ...
                    if(sreccWidth<=1366){
	                        ...
	                        {
	                    		if(top<25){
	                    			g.show({ top: itemtop-100, left: $(this).offset().left + $(this).width() - 5 }, g.menus[ligeruimenutemid]);
	                    			//console.log("进入24")
	                    		}else{
	                    			//console.log("不进入24")
                    	...
                    	//$("[ligeruiparentmenuitemid=8]").css("top","200px !important")
                    	return;
                    }
                    else (g.menus[ligeruimenutemid])
                    {
                    	//console.log("大屏")
                        g.show({ top: itemtop-defaultWidth, left: $(this).offset().left + $(this).width() - 5 }, g.menus[ligeruimenutemid]);
                        menu.showedSubMenu = true;
                    }
                }
            }, function ()
