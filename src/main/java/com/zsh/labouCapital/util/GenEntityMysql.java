...
public class GenEntityMysql {
	...
	private String packageOutPath = "com.zsh.labouCapital.entity";// 指定实体生成所在包的路径
	...
	private void generate(String[] generateTables) throws Exception {
		...
		for (int j = 0; j < tableNames.size(); j++) {
			...
			pStemt = (PreparedStatement) con.prepareStatement(tableSql);
	...
	public static void main(String[] args) {
		try {
			...
			String[] generateTables = { "t_trade_model"};
